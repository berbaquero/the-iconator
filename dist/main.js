...
var _modulesRenderImageJs = require('./modules/renderImage.js');

var _modulesRenderImageJs2 = _interopRequireDefault(_modulesRenderImageJs);
...
var dropContainer = '.js-image-drop-area';

(0, _dragDropBuffer2['default'])(dropContainer, function (files) {
	var file = files[0];
...
var renderFromCanvas = function renderFromCanvas(initialCanvas, sizeIndex) {
	...
	var newSizeContext = newSizeCanvas.getContext('2d');

	newSizeCanvas.height = newSize;
	newSizeCanvas.width = newSize;

	newSizeContext.drawImage(initialCanvas, 0, 0, initialCanvas.width, initialCanvas.height, 0, 0, newSizeCanvas.width, newSizeCanvas.height);

	var resultImage = document.querySelector('.js-result-' + newSize);
...
},{"./modules/imageSizes.js":2,"./modules/renderImage.js":3,"drag-drop/buffer":8}],2:[function(require,module,exports){
"use strict";
...
var renderImage = function renderImage(base64, canvasEl) {
	...
	canvasEl.src = 'data:image/jpeg;base64,' + base64;
};
...
},{"./":9,"blob-to-buffer":10,"run-parallel":17}],9:[function(require,module,exports){
...
},{"flatten":13,"lodash.throttle":14,"run-parallel":17}],10:[function(require,module,exports){
...
},{"typedarray-to-buffer":11}],11:[function(require,module,exports){
(function (Buffer){
/**
...
},{"buffer":4,"is-typedarray":12}],12:[function(require,module,exports){
...
},{"dezalgo":18}],18:[function(require,module,exports){
...
},{"asap":19,"wrappy":21}],19:[function(require,module,exports){
"use strict";
